...
export default function VirtualTour() {
  ...
  return (
    <div style={{ background: "var(--off-white, #F3ECE1)", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "1300px", margin: "0 auto", padding: "0.5rem 1.5rem 4rem" }}>
        ...
        <h1 style={{ fontFamily: "Fraunces, serif", fontSize: "clamp(1.9rem, 4.5vw, 2.75rem)", color: "var(--black, #0E0D0C)", margin: "0 0 0.75rem" }}>
          Step inside our work
        </h1>
        <p style={{ fontFamily: "Inter, sans-serif", color: "#0E0D0C88", maxWidth: "60ch", marginBottom: "2rem" }}>
          Photos only tell part of the story. Tap "View in 360°" below to look around a real
        ...
        <div className="tourGrid">
          ...
          <div style={{ background: "#FFFFFF", border: "1px solid #0E0D0C14", padding: "1.75rem" }}>
            <h2 style={{ fontFamily: "Fraunces, serif", fontSize: "1.25rem", color: "var(--black, #0E0D0C)", margin: "0 0 1rem" }}>
              About This Space
            </h2>
