...
export default function VirtualTour() {
  useSEO({
    title: "Virtual Walkthrough | OB Designs & Interiors",
    description:
      "Take a cinematic virtual walkthrough of an OB Designs & Interiors project — scroll to move through the space and see the quality of our finishing work up close.",
  });
        ...
        >
          ...
          >
            {[
              ...
              "High-quality materials on every job",
